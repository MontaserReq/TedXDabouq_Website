...
export default function Home() {
  return (
    <main className="snap-y snap-mandatory scroll-smooth overflow-y-scroll scroll-hidden h-screen bg-cover bg-center bg-no-repeat ">
      <section id="Hero" className="w-full flex justify-center items-center bg-[url('../../public/images/Cover.svg')] bg-cover bg-[30%] bg-no-repeat ">
        <Hero className="h-screen w-full snap-start flex justify-center items-center" />
      </section>
      <section id="ted" className="w-full flex justify-center items-center bg-[rgba(10,10,10,0.92)]">
        <Ted className="h-screen w-full snap-start flex justify-center items-center" />
      </section>
      <section id="aboutus" className="w-full flex justify-center items-center bg-[url('../../public/images/Cover.svg')] bg-cover bg-[60%] bg-no-repeat">
      ...
      <section id="contact" className="w-full flex justify-center items-center  bg-[url('../../public/images/Cover.svg')] bg-cover bg-[30%] bg-no-repeat ">
